...
public class SelfMonthView extends MonthView {
    ...
    public SelfMonthView(Context context) {
        super(context);
...
//        mSelectedPaint.setMaskFilter(new BlurMaskFilter(30, BlurMaskFilter.Blur.SOLID));
    ...
    protected void onPreviewHook() {
        ...
        mSelectedPaint.setColor(0xFFf94a21);


        mSchemeTextPaint.setColor(0xFFff7700);
    }
...
//        canvas.drawCircle(cx, cy, mRingRadius, mRingPaint);
    ...
    protected void onDrawScheme(Canvas canvas, Calendar calendar, int x, int y) {
        mSchemePaint.setColor(0xFFff7700);
        int cx = x + mItemWidth / 2;
        int cy = y + mItemHeight / 2;
        canvas.drawCircle(cx, cy, mRingRadius, mSchemePaint);
    }
